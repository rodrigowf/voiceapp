...
export default function AssociationsBkpp() {
    ...
    useEffect(() => {
        setLoading(true);
        phrasesApi.getList().then((phrs)=>{
            setPhrases(phrs);
            actionsApi.getList().then((acts)=>{
                setActions(acts);
    ...
    const columns = [
        ...
        { field: 'phrase_id', headerName: 'Frase', renderCell: renderSelectCell, renderEditCell: renderSelectEditInputCell, width: 400, editable: true, sortable: false , flex: 1 },
        { field: 'action_id', headerName: 'Ação', renderCell: renderSelectCell, renderEditCell: renderSelectEditInputCell, width: 400, editable: true, sortable: false , flex: 1 },
        {
            field: 'actions',
            type: 'actions',
            headerName: 'Excluir',
