...
export default function Actions() {
    ...
    const columns = [
        ...
        { field: 'program', headerName: 'Programa / Device', width: 300, editable: true, sortable: false , flex: 1  },
        { field: 'parameters', headerName: 'Parâmetros', width: 300, editable: true, sortable: false , flex: 1 },
        {
            field: 'actions',
            type: 'actions',
            headerName: 'Excluir',
